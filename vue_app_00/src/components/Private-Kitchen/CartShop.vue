<template>
    <div class="product-app">
        ...
        <div class="goods-item" v-for="(item,i) of list" :key="i">
            ...
            <mt-button class="addCart"  @click="addCart" :data-lid="item.lid" :data-lname="item.lname" :data-price="item.price" :data-img_url="'http://127.0.0.1:3000/'+item.img_url">加入购物车</mt-button>
        </div>
